      ...
      <div class="row">
        ...
        <main class="col-sm-9 offset-sm-3 col-md-9 col-lg-10 offset-md-3 offset-lg-2 right_content">
          ...
          <div class="photo_groups">
              <div class="row">
                <div class="col-md-3 ph_group">
                    <a href="#" class="ph_title">Зима в «Солнечном»<br />2017-2018</a>
                    <a href="#" class="images_group">
                      <img src="images/gr1.jpg">
                      <p class="num">167 фото</p>
                    </a>                  
                </div>
                <div class="col-md-3 ph_group">
                    <a href="#" class="ph_title">День района<br />02.09.2017</a>
                    <a href="#" class="images_group">
                ...
                <div class="col-md-3 ph_group">
                    <a href="#" class="ph_title">Семейный фестиваль<br />«Дом Солнца» 03.06.2017</a>
                    <a href="#" class="images_group">
                ...
                <div class="col-md-3 ph_group">
                    <a href="#" class="ph_title">Иннопром<br />2017</a>
                    <a href="#" class="images_group">
              ...
              <div class="row">
                <div class="col-md-3 ph_group">
                    <a href="#" class="ph_title">Солнечная масленница<br />26.02.2017</a>
                    <a href="#" class="images_group">
                ...
                <div class="col-md-3 ph_group">
                    <a href="#" class="ph_title">Фестиваль снеговиков<br />26.01.2017</a>
                    <a href="#" class="images_group">
                ...
                <div class="col-md-3 ph_group">
                    <a href="#" class="ph_title">День района<br />10.09.2016</a>
                    <a href="#" class="images_group">
                ...
                <div class="col-md-3 ph_group">
                    <a href="#" class="ph_title">Новый год<br />2016</a>
                    <a href="#" class="images_group">
