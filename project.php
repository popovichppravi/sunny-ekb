      ...
      <div class="row">
        ...
        <!--SIDEBAR_MENU-->
          ...
          <ul class="flex-column sidebar_menu">
            ...
            <li><a class="active" href="#">Особенности проекта</a></li>
          ...
          <!--TOP NAVMENU-->
            <nav class="top-navbar navbar navbar-toggleable-md navbar-inverse">
              ...
              <a class="top_logo" href="#"><img src="images/top_logo.svg" /></a>
                <ul class="top_title"><li><h1>Особенности проекта</h1></li></ul>

            </nav>
          <!--//TOP NAVMENU-->
             <div class="big_img_block" style="background-image: url('images/pj_bg.jpg')">
                <div class="bottom_info">
                            <h2>«Форум-групп»</h2>
                            <p>девелопер проекта и генеральный застройщик жилого района «Солнечный» - реализует один из крупнейших проектов комплексного развития территории в Уральском регионе. Совместно с крупными застройщиками Генеральный застройщик создает район, образующий новое качество жизни.</p>                            
                </div>
             </div>
